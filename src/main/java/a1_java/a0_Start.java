...
// Класс название совпадает с файлом

public class a0_Start {

    // psvm - обязательный метод в классе
    public static void main(String[] args) {

        //sout
        System.out.print("Hello, world! ");     // Вывод с консоль без перевода каретки на новую строку
        System.out.println("It's my first project");     // Вывод с консоль с новой строки
    }
}
